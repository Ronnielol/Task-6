...
describe Cinema::Movie do 
	...
	describe Cinema::AncientMovie do
		...
		subject {Cinema::AncientMovie.new('http://imdb.com/title/tt0034583/?ref_=chttp_tt_32', 'Casablanca', '1942', 'USA', '1943-01-23', 
	...
	describe Cinema::ClassicMovie do
		...
		subject {Cinema::ClassicMovie.new('http://imdb.com/title/tt0036868/?ref_=chttp_tt_195', 'The Best Years of Our Lives', '1946', 'USA', '1947-06-17', 
	...
	describe Cinema::ModernMovie do
		...
		subject {Cinema::ModernMovie.new('http://imdb.com/title/tt0111161/?ref_=chttp_tt_1', 'The Shawshank Redemption', '1994', 'USA', '1994-10-14', 
